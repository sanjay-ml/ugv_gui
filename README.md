...
This repository is a **prototype** for integrating a **ROS2 node** with **FastAPI** in a single Python application.

The code demonstrates:
- Creating and spinning a ROS2 node
- Exposing ROS topic data through REST APIs
- Publishing ROS commands via HTTP endpoints
